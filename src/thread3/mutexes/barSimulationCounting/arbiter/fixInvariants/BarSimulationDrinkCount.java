package thread3.mutexes.barSimulationCounting.arbiter.fixInvariants;
...
public class BarSimulationDrinkCount
{
	...
	private static void displayStatistics()
	{
		for (int i = 1; i <= numberOfThreads; i++)
		{
			...
			int[] resultsSoFar = arbiter.getNumBoughtAndRoundsSoFar(name);
			
			int roundsBought = resultsSoFar[0];
			int roundsSoFar = resultsSoFar[1];
