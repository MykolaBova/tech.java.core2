...
public class FlatMapExamples {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Stream<String> stream1 = Files.lines(Paths.get("src/java81/j2/files/TomSawyer_01.txt")) ;
        Stream<String> stream2 = Files.lines(Paths.get("src/java81/j2/files/TomSawyer_02.txt")) ;
        Stream<String> stream3 = Files.lines(Paths.get("src/java81/j2/files/TomSawyer_03.txt")) ;
        Stream<String> stream4 = Files.lines(Paths.get("src/java81/j2/files/TomSawyer_04.txt")) ;
